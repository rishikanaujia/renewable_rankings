...
class CountryAnalysisAgent:
    ...
    def _get_default_weights(self) -> Dict[str, float]:
        """Default subcategory weights if config is unavailable."""
        return {
            "regulation": 0.20,
            "market_size_fundamentals": 0.20,
            "profitability": 0.25,
            "accommodation": 0.15,
            "competition_ease": 0.10,
            "system_modifiers": 0.10
        }
    ...
    def _get_strength_reason(self, area: str, score: float) -> str:
        ...
        reasons = {
            ...
            "Competition Ease": "Open competitive market with low barriers",
    ...
    def _get_weakness_reason(self, area: str, score: float) -> str:
        ...
        reasons = {
            ...
            "Market Size Fundamentals": "Limited market scale or resources",
            "Profitability": "Lower returns or challenging economics",
            "Accommodation": "Infrastructure constraints or access barriers",
            "Competition Ease": "Market concentration or entry barriers",
            "System Modifiers": "Elevated systemic risks (currency, geopolitical)"
        }
    ...
    def _get_score_interpretation(self, score: float) -> Dict[str, str]:
        ...
        # Default fallback
        if score >= 8.0:
            return {"label": "Excellent", "description": "Highly attractive market"}
        elif score >= 6.0:
            return {"label": "Good", "description": "Solid investment opportunity"}
        elif score >= 4.0:
            return {"label": "Moderate", "description": "Notable challenges exist"}
        else:
            return {"label": "Poor", "description": "Significant barriers present"}
