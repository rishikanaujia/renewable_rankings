...
from ..services.ranking_service_adapter import ranking_service_adapter
...
class RankingsApp:
    ...
    def __init__(self):
        ...
        if use_real_agents:
            self.service = ranking_service_adapter
            logger.info("RankingsApp initialized with REAL AGENTS (AI-powered analysis)")
        else:
            self.service = mock_service
            logger.info("RankingsApp initialized with MOCK SERVICE (sample data)")

        logger.info(f"Active service: {self.service.__class__.__name__}")
    ...
    def create_interface(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            *Version {self.config['app']['version']} - Phase 1 UI Demo*
            ...
            if use_real_agents:
                banner_class = "data-source-banner real-mode"
                banner_icon = "🤖"
                banner_text = "**REAL AGENTS MODE** - Using AI-powered analysis with live agents"
                banner_detail = "Data is generated by 18 parameter agents analyzing real-world information"
            else:
                banner_class = "data-source-banner mock-mode"
                banner_icon = "📋"
                banner_text = "**DEMO MODE** - Using sample data for testing"
                banner_detail = "Switch to real agents by setting USE_REAL_AGENTS=true in .env"
