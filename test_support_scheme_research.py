#!/usr/bin/env python3
"""Test Support Scheme Agent with Research Integration

This script demonstrates the research_integration package working
with Support Scheme Agent.
"""
...
from src.agents.parameter_agents.support_scheme_agent import SupportSchemeAgent
...
def test_research_integration():
    """Test Support Scheme Agent with research integration."""
    print_section("Support Scheme Agent - Research Integration Test")
    ...
    agent = SupportSchemeAgent(mode=AgentMode.RULE_BASED)
...
def test_comparison():
    ...
    for country in countries:
        # MOCK mode
        agent_mock = SupportSchemeAgent(mode=AgentMode.MOCK)
        result_mock = agent_mock.analyze(country, "Q4 2024")

        # RULE_BASED with research
        agent_research = SupportSchemeAgent(mode=AgentMode.RULE_BASED)
...
def main():
    ...
    print("   2. SupportSchemeParser extracting policy metrics")
    ...
    try:
        ...
        print("   • SupportSchemeParser extracting metrics")
